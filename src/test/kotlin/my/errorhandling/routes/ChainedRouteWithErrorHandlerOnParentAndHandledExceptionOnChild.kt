...
class ChainedRouteWithErrorHandlerOnParentAndHandledExceptionOnChild : BaseTestSupport() {
    ...
    @Test
    fun `when having an exception on doCatch, the parentOnException() will catch the exception`() {
